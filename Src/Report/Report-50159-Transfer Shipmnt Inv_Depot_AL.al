report 50159 "Transfer Shipmnt Inv_Depot_AL"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/TransferShipmntInvDepotAL.rdl';
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(Integer; Integer)
                {
                    ...
                    dataitem("Transfer Shipment Line"; "Transfer Shipment Line")
                    {
                        ...
                        column(ADEAmount_TransferShipmentLine; AddlDutyAmount)
                        {
                        }
                        ...
                        begin
                            ...
                            */
                            ...
                            "Transfer Shipment Line".Amount + 0;//"Transfer Shipment Line"."BED Amount" + "Transfer Shipment Line"."eCess Amount"
                                                                // + "Transfer Shipment Line"."SHE Cess Amount" + FrieghtAmount + AddlDutyAmount + RoundOffAmnt;
                                                                /*
                                                                DocTotal +=ROUND((
                            ...
                            vCheck.FormatNoText(DescriptionLineDuty, ROUND(vBED, 0.01), '');
                            ...
                            vCheck.InitTextVariable;
                            vCheck.FormatNoText(DescriptionLineAD, ROUND(AddlDutyAmount, 0.01), '');
