report 50241 "High Seas Invoice"
{
    // 
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/HighSeasInvoice.rdl';
                        ...
                        begin
                            ...
                            */
                            ...
                            END ELSE BEGIN
                                ...
                                TotalQtyFO := "Sales Invoice Line".Quantity; // Fahim 17-08-2023
                                                                             //BasicRate := "Unit Price" / "Qty. per Unit of Measure";//RSPLSUM 19Jan21
                                BasicRate := "Unit Price";//Fahim 17-08-2023
                            END;
                            //RSPLSUM 12Jan21<<
