report 50107 "Invoice COAL GST--LOGO"
{
    // 
    // Date        Version      Remarks
    // .....................................................................................
    // 18Dec2017   RB-N         New Report saveas from Report#50076
    DefaultLayout = RDLC;

    RDLCLayout = 'Src/Report Layout/InvoiceCOALGSTLOGO.rdl';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    Caption = 'Invoice COAL GST--LOGO';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(TCSinWord15; TCSiinWord15[1])
            {
            }
            column(CESSinWord15; CESSinWord15[1])
            {
            }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(Integer; Integer)
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(TCSPer; 0)// FORMAT("TDS/TCS %") + ' ' + '%')
                        {
                        }
                        column(TCSAmt; 0)//"Sales Invoice Line"."TDS/TCS Amount")
                        {
                        }
                        column(CessAmt18; CessAmt18)
                        {
                        }
                        ...
                        begin
                            ...
                            */
                            ...
                            IF "Item Category Code" = 'CAT16' THEN
                                DimensionName := Description;
                            ...
                            */
                            ...
                            //>>CessAmount 19Dec2017
                            /*  IF recStrOrderLineDet."Tax/Charge Group" = 'CESS' THEN BEGIN

                                 CessAmt18 += recStrOrderLineDet.Amount;
                         ...
                         UNTIL recStrOrderLineDet.NEXT = 0; */
                            ...
                            */
                            ...
                            vCheck.InitTextVariable;
                            vCheck.FormatNoText(DescriptionLineAD, ROUND(0/*"ADE Amount"*/, 0.01), '');
            ...
            begin
                ...
                //>>01Aug2017
                IF "Sales Invoice Header"."Posting Date" < 20170801D/*010817D*/ THEN
                ...
                IF SL14.FINDSET THEN
                    REPEAT
                        ...
                        TCSAmt18 += 0;// SL14."TDS/TCS Amount";//19Dec2017
                ...
                //>>TCSinWords 19Dec2017
                vCheck.InitTextVariable;
                vCheck.FormatNoText(TCSiinWord15, ROUND((TCSAmt18), 0.01), '');
                TCSiinWord15[1] := DELCHR(TCSiinWord15[1], '=', '*');
                ...
                //>>Cess Amount 19Dec2017
                CLEAR(CESSAmt19);
                /*  recStrOrderLineDet.RESET;
                 recStrOrderLineDet.SETRANGE("Invoice No.", "No.");
                 recStrOrderLineDet.SETRANGE("Tax/Charge Group", 'CESS');
                 recStrOrderLineDet.SETRANGE("Tax/Charge Type", recStrOrderLineDet."Tax/Charge Type"::Charges);
                 IF recStrOrderLineDet.FINDSET THEN
                     REPEAT

                         CESSAmt19 += recStrOrderLineDet.Amount;

                     UNTIL recStrOrderLineDet.NEXT = 0;
  */
                //>>Cess AmountinWords
                vCheck.InitTextVariable;
                vCheck.FormatNoText(CESSinWord15, ROUND((CESSAmt19), 0.01), '');
                CESSinWord15[1] := DELCHR(CESSinWord15[1], '=', '*');
                ...
                IF RecSIL.FINDFIRST THEN
                    UOMCode := RecSIL."Unit of Measure Code";
                ...
                CLEAR(TCSPercent);
                RecSILN.RESET;
                RecSILN.SETRANGE("Document No.", "No.");
                RecSILN.SETRANGE(Type, RecSILN.Type::Item);
                RecSILN.SETFILTER(Quantity, '<>%1', 0);
                IF RecSILN.FINDFIRST THEN BEGIN
                    //IF RecSILN."TDS/TCS %" <> 0 THEN
                    TCSPercent := '  ';// FORMAT(RecSILN."TDS/TCS %") + ' %';
                END;
                //RSPLSUM-TCS<<
    ...
    begin
        ...
        // To Print Invoice Only Once after First Print out of 4 pages are Taken-----START
        IF "Sales Invoice Header"."Print Invoice" = FALSE THEN BEGIN
            ...
            END;
        END;
        // To Print Invoice Only Once after First Print out of 4 pages are Taken-------END
    end;
    ...
    var
        ...
        "--------------18Dec2017": Integer;
        CessAmt18: Decimal;
        TCSiinWord15: array[2] of Text[150];
        CESSinWord15: array[2] of Text[150];
        TCSAmt18: Decimal;
        CESSAmt19: Decimal;
