report 50207 "Posted Voucher--New"
{
    // 
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/PostedVoucherNew.rdl';
            ...
            begin
                ...
                *///commented 15May2017
                ...
                IF "System-Created Entry" AND ("G/L Entry"."Source Type" = "G/L Entry"."Source Type"::Vendor) THEN BEGIN
                    ...
                    AccountName26 := Vend."No." + ' - ' + Vend.Name;
                END;
                ...
                OR ("G/L Account No." = '32120700') OR ("G/L Account No." = '32120800')
                OR ("G/L Account No." = '32120900') OR ("G/L Account No." = '32121000') THEN BEGIN
                ...
                OR ("G/L Account No." = '12791000') OR ("G/L Account No." = '12792000') OR ("G/L Account No." = '12795000') THEN BEGIN
