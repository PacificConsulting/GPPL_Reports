report 50044 "Sales Debit Memo"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/SalesDebitMemo.rdl';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;

    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Invoice Header")
        {
            ...
            column(BilltoName; "Sell-to Customer Name")
            {
            }
            column(BillAdd1; "Sell-to Address")
            {
            }
            column(BillAdd2; "Sell-to Address 2")
            {
            }
            column(BillAdd3; "Sell-to City" + ' - ' + "Sell-to Post Code")
            {
            }
            ...
            dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
            {
                ...
                column(TaxDesc; /*"Sales Cr.Memo Line"."Tax Amount"*/0 - "AddlTax&Cess")
                {
                }
                ...
                begin
                    ...
                    */
                    ...
                    //>>06Apr2017
                    //For TDS amount PARAG 02.03.2016
                    // IF "TDS/TCS Amount" <> 0 THEN BEGIN
                    TDStext := 'TCS';
                    ...
                    IF "Sales Cr.Memo Header"."Currency Code" = '' THEN
                        vTotAmt += "Sales Cr.Memo Line"."Line Amount" + 0 /*"Sales Cr.Memo Line"."Tax Amount" */+ AddlDutyAmount + Cess + EntryTax + tcsamt
                    ELSE
                        vTotAmt += "Sales Cr.Memo Line"."Line Amount" + 0/*"Sales Cr.Memo Line"."Tax Amount"*/ + AddlDutyAmount + Cess + EntryTax + tcsamt / "Sales Cr.Memo Header"."Currency Factor";
            ...
            dataitem("Sales Comment Line"; "Sales Comment Line")
            {
                ...
                column(CommText; CommText)
                {
                }

                trigger OnAfterGetRecord()
                begin
                    CommText += "Sales Comment Line".Comment;
                    //MESSAGE(' %1 Comm', CommText);
                    /*
                    UserRec.RESET;
