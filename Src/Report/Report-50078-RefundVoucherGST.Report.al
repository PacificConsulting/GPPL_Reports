// report 50078 "Refund Voucher GST"
// {
//     // 17July2017 :: RB-N, New Report format for GST Payment Voucher.
//     DefaultLayout = RDLC;
//     RDLCLayout = './RefundVoucherGST.rdlc';
...
//                                 WHERE (Document Type=FILTER(Refund),
...
//                 IF "G/L Entry"."Document Type" <> "G/L Entry"."Document Type"::Refund THEN
//                   ERROR('This report is applicable for Refund Voucher.');
