report 50048 "Supplimentary Depot Inv--IL"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/SupplimentaryDepotInvIL.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(BranchOffice; RespCentre.Address + ' ' + RespCentre."Address 2" + ' ' + RespCentre.City + ' ' + RespCentre."Post Code" + ' ' + RecState1.Description + ' Phone: ' + RespCentre."Phone No." + ' ' + ' Email: ' + RespCentre."E-Mail")
            {
            }
            column(CompInfo; 'Website :' + RecCompInfo."Home Page" + '   C.I.N No. :' + 'RecCompInfo."Company Registration  No."' + '  PAN No. :' + RecCompInfo."P.A.N. No.")
            {
            }
            column(PAN_ComInfo; 'PAN No: ' + CompanyInfo1."P.A.N. No.")
            {
            }
            column(InvNo; InvNo)
            {
            ...
            column(BillToSate; BillToStatc.Description + ', ' + RecCountry.Name)
            {
            }
            ...
            column(City_Loc; Loc.City)
            {
            }
            dataitem(CopyLoop; 2000000026)
            {
                DataItemTableView = SORTING(Number);
                dataitem(DataItem1000000091; 2000000026)
                {
                    DataItemTableView = SORTING(Number)
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(ExciseAmt; /*"Sales Invoice Line"."Excise Amount"*/0 / "Sales Invoice Line"."Quantity (Base)")
                        {
                        }
                        ...
                        dataitem(SIL; "Sales Invoice Line")
                        {
                            ...
                            column(UnitPrice; "Sales Invoice Line"."Unit Price" / "Sales Invoice Line"."Qty. per Unit of Measure")
                            {
                            }
                        ...
                        begin
                            ...
                            /*   PostedStrOrdDetails1.RESET;
                              ...
                              REPEAT */
                            ADDTAX := ADDTAX + 0;// PostedStrOrdDetails1.Amount;
            ...
            begin
                ...
                IF vSalesInv.FINDSET THEN
                    REPEAT
                        ...
                        // SheCess  +=  vSalesInv."Amount To Customer"+RoundOffAmnt;
                        SheCess += 0;//vSalesInv."SHE Cess Amount";
