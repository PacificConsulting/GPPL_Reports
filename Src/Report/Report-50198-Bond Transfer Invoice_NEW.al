report 50198 "Bond Transfer Invoice_NEW"
{
    // 
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/BondTransferInvoiceNEW.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(FactoryLocation; FactoryLocation)
            {
            }
            column(FactoryLocation1; LocFrom.Address + ' ' + LocFrom."Address 2" + ' ' + LocFrom.City + ' - ' + LocFrom."Post Code" + ' ' + LocState + ' ' + ' Phone: ' + LocFrom."Phone No." + ' Email: ' + LocFrom."E-Mail")
            {
            }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(Integer; Integer)
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(QuantityBase_Line2; TotalQtyFO)
                        {
                        }
                        column(QuantityBase_Line; "Sales Invoice Line".Quantity)
                        {
                        }
                        ...
                        column(Unitprice_QtyPerUnit; "Sales Invoice Line"."Unit Price")
                        {
                        }
                        column(Unitprice_QtyPerUnit2; BasicRate)
                        {
                        }
                            ...
                            IF (DimensionName = '') OR (recItemEBT."Item Category Code" = 'CAT02') OR (recItemEBT."Item Category Code" = 'CAT03') OR
                              (recItemEBT."Item Category Code" = 'CAT11') OR (recItemEBT."Item Category Code" = 'CAT12') OR
                                ...
                                IF (DimensionName = '') AND ("Item Category Code" <> 'CAT01')
                                    ...
                                    //DimensionName := 'IPOL ' + Description;//Sid 20June2021
                                    DimensionName := Description;//Sid 20June2021
   ...
   */
                            ...
                            */
                            ...
                            IF "Sales Invoice Line"."Item Category Code" = 'CAT05' THEN BEGIN
            ...
            begin
                ...
                IF BLocation <> '' THEN BEGIN
                    IF LocFrom1.GET(BLocation) THEN BEGIN
                        IF RecState.GET(LocFrom1."State Code") THEN//SKM
                            LocState := RecState.Description;//SKM
                        FactoryLocation := LocFrom1.Address + ' ' + LocFrom1."Address 2" + ' ' + LocFrom1.City + ' - ' + LocFrom1."Post Code" + ' ' + LocState + ' ' + ' Phone: ' + LocFrom1."Phone No." + ' Email: ' + LocFrom1."E-Mail"
                    END;
                END;
                //RSPL AM19062021 >>
