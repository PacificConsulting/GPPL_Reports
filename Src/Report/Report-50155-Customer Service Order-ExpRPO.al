report 50155 "Customer Service Order-ExpRPO"
{
    // Date        Version      Remarks
    // .....................................................................................
    // 25Oct2017   RB-N         Dispalying GST% as per Actual Entry.
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/CustomerServiceOrderExpRPO.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                column(TotalAmt; ("Sales Line"."Line Amount" + /*"Sales Line"."Excise Amount"*/0 + TotalTaxValue + /*"Sales Line"."Charges To Customer"*/0 - "Sales Line"."Line Discount Amount"))
                {
                }
