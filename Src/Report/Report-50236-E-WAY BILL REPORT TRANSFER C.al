report 50236 "E-WAY BILL REPORT TRANSFER C"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/EWAYBILLREPORTTRANSFERC.rdl';
    ...
    dataset
    {
        dataitem("Transfer Shipment Header"; "Transfer Shipment Header")
        {
            ...
            column(ApproxDistance; "Transfer Shipment Header"."Distance in kms")
            {
            }
            column(Type; Type)
            {
            }
            column(DocumentDetails; DocType + ' - ' + "Transfer Shipment Header"."No." + ' - ' + FORMAT("Transfer Shipment Header"."Posting Date", 0, '<Day,2>/<Month,2>/<Year4>'))
            {
            }
            column(TransactionType; "Transfer Shipment Header"."EWB Transaction Type")
            {
            }
            ...
            column(TotalInvAmt; TotTaxAmt + CGST + SGST + IGST + Cess + CessNonAdvol + OtherAmt)
            {
            }
            column(TransporterIDName; TransporterIDName)
            {
            }
            column(TranspoterDocNoDate; "Transfer Shipment Header"."LR/RR No." + ' & ' + FORMAT("Transfer Shipment Header"."LR/RR Date"))
            {
            }
            ...
            column(CancelledSet; CancelledSet)
            {
            }
            dataitem("Transfer Shipment Line"; "Transfer Shipment Line")
            {
                ...
                column(TaxableAmount; "Transfer Shipment Line".Amount)
                {
                }
                ...
                begin
                    CLEAR(HSNSACDIS);
                    RecHSNSAC.RESET;
                    RecHSNSAC.SETRANGE(Code, "Transfer Shipment Line"."HSN/SAC Code");
                    ...
                    //RecDGSTLE.SETRANGE("Original Doc. Type", RecDGSTLE."Original Doc. Type"::"Transfer Shipment");
                    RecDGSTLE.SETRANGE("Transaction Type", RecDGSTLE."Transaction Type"::Sales);
                    RecDGSTLE.SETRANGE("Document Line No.", "Transfer Shipment Line"."Line No.");
                    ...
                    IF RecUnitOfMeasure.GET("Transfer Shipment Line"."Unit of Measure Code") THEN
            ...
            dataitem("Detailed E-Way Bill"; "Detailed E-Way Bill")
            {
                ...
                column(ModeVehicle; ModeVehicleNew)
                {
                }
                ...
                begin
                    ...
                    //IF RecShipmentMethod.GET("Transfer Shipment Header"."Shipment Method Code") THEN;
                    CLEAR(ModeVehicleNew);
                    ModeVehicleNew := 'Road';

                    RecDGSTLENew.RESET;
                    RecDGSTLENew.SETRANGE("Document No.", "Transfer Shipment Header"."No.");
                    RecDGSTLENew.SETRANGE("Posting Date", "Transfer Shipment Header"."Posting Date");
                ...
                begin
                    IF EwayBillNoSet <> '' THEN//RSPLSUM27520
                        SETRANGE("Detailed E-Way Bill"."EWB No.", EWayBillNo);//RSPLSUM27520
                end;
            }
            ...
            begin
                ...
                CLEAR(EWayBillNo);
                IF EwayBillNoSet <> '' THEN//RSPLSUM27520
                    EWayBillNo := EwayBillNoSet//RSPLSUM27520
                ELSE BEGIN//RSPLSUM27520
                    GSTLedgerEntry.RESET;
                    GSTLedgerEntry.SETRANGE("Document No.", "Transfer Shipment Header"."No.");
                    GSTLedgerEntry.SETRANGE("Posting Date", "Transfer Shipment Header"."Posting Date");
                ...
                CLEAR(EWBUpdateDate);
                DetailedsEWayBill1.RESET;
                DetailedsEWayBill1.SETRANGE("Document No.", "Transfer Shipment Header"."No.");
                DetailedsEWayBill1.SETRANGE("EWB No.", EWayBillNo);
                ...
                CLEAR(FromAddr);
                CLEAR(VehFrom);
                IF Location1.GET("Transfer Shipment Header"."Transfer-from Code") THEN BEGIN
                    FromLocName := Location1.Name;
                    VehFrom := Location1.City;
                    RecState.RESET;
                    IF RecState.GET(Location1."State Code") THEN BEGIN
                        ...
                        FromGSTIN := Location1."GST Registration No.";
                    END;
                END;
                ...
                IF Location1.GET("Transfer Shipment Header"."Transfer-to Code") THEN BEGIN
                    ToGSTIN := Location1."GST Registration No.";
                    ToLocName := Location1.Name;
                    RecState.RESET;
                    IF RecState.GET(Location1."State Code") THEN BEGIN
                        ToLocState := RecState.Description;
                        ToAddr[1] := Location1.Address;
                        ToAddr[2] := Location1."Address 2";
                        ToAddr[3] := Location1.City + ',' + ToLocState + '-' + Location1."Post Code";
                    END;
                END;
                ...
                //RecTSL.SETFILTER(Type,'<>%1',RecSIL.Type::" ");
                IF RecTSL.FINDSET THEN
                    REPEAT
                        TotTaxAmt += RecTSL.Amount;
                    UNTIL RecTSL.NEXT = 0;
                ...
                /*-- also ask for transaction type--taxable amount, TotInvAmt
                CLEAR(Type);
                ...
                */
                RecDetGSTLE.RESET;
                RecDetGSTLE.SETRANGE("Document No.", "Transfer Shipment Header"."No.");
                RecDetGSTLE.SETRANGE("Posting Date", "Transfer Shipment Header"."Posting Date");
                IF RecDetGSTLE.FINDFIRST THEN;

                IF FromGSTIN = ToGSTIN THEN
                ...
                RecDetEwayBillNew.SETRANGE("Document No.", "Transfer Shipment Header"."No.");
                RecDetEwayBillNew.SETRANGE("EWB No.", EWayBillNo);//RSPLSUM27520
  ...
  */
    ...
    begin
        ...
        DetaiGSTLedgEnt.SETRANGE("Document No.", "Transfer Shipment Header"."No.");
        DetaiGSTLedgEnt.SETRANGE("Posting Date", "Transfer Shipment Header"."Posting Date");
    ...
    begin
        ...
        //ADD STOP CHARACTER
        //lrecTmpCode128.GET(DocNo1,EWayBillNo,'STOP'); //RSPL-AR AR-EWB commented DJ 31/08/2020
        lrecTmpCode128.RESET;
        lrecTmpCode128.SETRANGE("Document No.", DocNo1);
        lrecTmpCode128.SETRANGE("EWB No.", EWayBillNo);
    ...
    // //[Scope('Internal')]
    procedure SetParams(EwayBillNoGet: Code[50]; CancelledGet: Boolean)
    begin
        EwayBillNoSet := EwayBillNoGet;
        CancelledSet := CancelledGet;
    end;
}
