// report 50011 "Customer Service Order - Indl"
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './CustomerServiceOrderIndl.rdlc';
...
//                 {
//                 }
//                 column(TotalAmt; ("Sales Line"."Line Amount" + "Sales Line"."Excise Amount" + TotalTaxValue + "Sales Line"."Charges To Customer" - "Sales Line"."Line Discount Amount"))
//                 {
//                 }
