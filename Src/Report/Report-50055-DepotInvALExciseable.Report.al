report 50055 "Depot Inv--ALExciseable"
{
    // 06Feb2017 : Plant Invoice-IL(#50003)
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/DepotInvALExciseable.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(SIH_BillAdd3; "Bill-to City" + '-' + "Bill-to Post Code" + ' ' + BillState + ', ' + BillCountry + '         PAN No.:' + recCompany."P.A.N. No.")
            {
            }
            ...
            column(SIH_ShipAdd3; "Ship-to City" + '-' + "Ship-to Post Code" + ' ' + ShipState + ', ' + ShipCountry + '     PAN No.:' + recCompany."P.A.N. No.")
            {
            }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(Integer; Integer)
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(ItmExciseRate; '"Sales Invoice Line"."Excise Effective Rate"')
                        {
                        }
                            ...
                            */
                            ...
                            /* IF "Sales Invoice Line"."Price Inclusive of Tax" THEN
                                IF "Sales Invoice Line"."Abatement %" = 0 THEN BEGIN
                                    MRPPrice := 0;
                                    AssValue := "Sales Invoice Line"."MRP Price";
                                END ELSE BEGIN
                                    MRPPrice := "Sales Invoice Line"."MRP Price" * "Sales Invoice Line"."Qty. per Unit of Measure";
                            ...
                            IF "Sales Invoice Line"."Posting Date" > 20130718D THEN BEGIN //180713D
                                CLEAR(ProdDisc);
                                MRPMaster.RESET;
                            ...
                            billingprice := ("Sales Invoice Line"."Unit Price" / "Sales Invoice Line"."Qty. per Unit of Measure")
                                            + ("Sales Invoice Line"."Excise Amount" / ("Sales Invoice Line"."Qty. per Unit of Measure"*
                    ...
                    begin
                        ...
                        */
                        ...
                        IF RecLocation2.FINDFIRST THEN BEGIN
                            IF (RecLocation2."State Code" = 'UP') AND ("Sales Invoice Header"."Posting Date" >= 20141101D) THEN //011114D
                                TaxInvoice := 'INVOICE';
                        END;
            ...
            begin
                ...
                /*  PostedStrOrdDetails.RESET;
                 ...
                 IF PostedStrOrdDetails.FINDFIRST THEN
                     REPEAT */
                CessValue := CessValue + 0;// PostedStrOrdDetails.Amount;
                                           // UNTIL PostedStrOrdDetails.NEXT = 0;
                IF CessValue <> 0 THEN
                    //  CessText := 'Cess @' + 0// FORMAT(PostedStrOrdDetails."Calculation Value") + ' ' + '%'
                    //ELSE
                    CessText := 'Cess %';
                ...
                "Entry/Octroi" := "Entry/Octroi" + 0;// PostedStrOrdDetails.Amount;
                                                     // UNTIL PostedStrOrdDetails.NEXT = 0;
                ...
                IF PostedStrOrdDetails.FINDFIRST THEN BEGIN
                    ...
                    REPEAT */
                ADDTAX := ADDTAX + 0;// PostedStrOrdDetails.Amount;
                                     // UNTIL PostedStrOrdDetails.NEXT = 0;
                                     //END;
                ...
                /*  PostedStrOrdrDetails.RESET;
                 ...
                 IF PostedStrOrdrDetails.FINDSET THEN
                     REPEAT */
                FOCAMOUNT := FOCAMOUNT + 0;//PostedStrOrdDetails.Amount;
                                           //UNTIL PostedStrOrdDetails.NEXT = 0;
                ...
                /*  recPostedStrOrdDetails.RESET;
                 ...
                 IF recPostedStrOrdDetails.FINDFIRST THEN
                     REPEAT */
                CashDiscountAmt += 0;// recPostedStrOrdDetails.Amount;
                ...
                CCFCtext := 'CCFC @ ' + '';// FORMAT(recPostedStrOrdDetails."Calculation Value") + ' ' + '%';
                                           // REPEAT
                CCFC += 0;// recPostedStrOrdDetails.Amount;
                          // UNTIL recPostedStrOrdDetails.NEXT = 0;
                          // END;
                ...
                IF DetailedTaxEntry.FINDFIRST THEN
                    REPEAT */
                TaxAmount := TaxAmount + 0;// DetailedTaxEntry."Tax Amount";
                ...
                */
                ...
                IF PostedStrOrdDetails.FINDFIRST THEN
                    REPEAT */
                TPTSUBSIDY += 0;//PostedStrOrdDetails.Amount;
                TPTSUBSIDYtext := 'Transport Subsidy';
                //UNTIL PostedStrOrdDetails.NEXT = 0;
                //<<
                ...
                /*  PostedStrOrdrLineDetails.RESET;
                 ...
                 IF PostedStrOrdrLineDetails.FINDFIRST THEN
                     REPEAT */
                Freight := +Freight + 0;// PostedStrOrdrLineDetails.Amount;
                ...
                IF PostedStrOrdrDetails.FINDFIRST THEN */
                DiscountCharge := 0;// PostedStrOrdrDetails."Calculation Value";
                ...
                /*  PostedStrOrdrLineDetails.RESET;
                 ...
                 IF PostedStrOrdrLineDetails.FINDFIRST THEN
                     REPEAT */
                AddlDutyAmount := AddlDutyAmount + 0;// PostedStrOrdrLineDetails.Amount;
                                                     //UNTIL PostedStrOrdrLineDetails.NEXT = 0;
               ...
               IF DetailedTaxEntry.FINDFIRST THEN BEGIN
                ...
                RecLocation2.SETRANGE(RecLocation2.Code, "Sales Invoice Header"."Location Code");
                IF RecLocation2.FINDFIRST THEN BEGIN
                    IF (RecLocation2."State Code" = 'UP') AND ("Sales Invoice Header"."Posting Date" >= 20141111D) THEN BEGIN //011114D
                ...
                DetailedTaxEntry.SETRANGE(DetailedTaxEntry."Tax Area Code", "Sales Invoice Line"."Tax Area Code");
                DetailedTaxEntry.SETRANGE(DetailedTaxEntry."Tax Jurisdiction Code", "Sales Invoice Line"."Tax Area Code");
                IF DetailedTaxEntry.FINDFIRST THEN BEGIN
                    IF DetailedTaxEntry."Form Code" <> '' THEN BEGIN
                        FormCode := 'with Form ' + DetailedTaxEntry."Form Code";
                    END;
