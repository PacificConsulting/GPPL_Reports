report 50235 "E-WAY BILL REPORT C"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/EWAYBILLREPORTC.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(TotalInvAmt; 0)// "Sales Invoice Header"."Amount to Customer")
            {
            }
            column(CGST; CGST)
            {
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                column(TaxableAmount; 0)// "Sales Invoice Line"."GST Base Amount")
                {
                }
            ...
            begin
                ...
                IF RecSIL.FINDSET THEN
                    REPEAT
                        ...
                        TotTaxAmt += 0;//RecSIL."GST Base Amount";//RSPLSUM 20Jul2020
                    UNTIL RecSIL.NEXT = 0;
