report 50213 "Invoice Automotive GST -- LOGO"
{
    // 
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/InvoiceAutomotiveGSTLOGO.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            begin
                ...
                //>>21Aug2017 Logo Baseon ItemCategory
                CLEAR(Cat21);
                CLEAR(Logo21);
                SL21.RESET;
    ...
    begin
        ...
        CompanyInfo1.CALCFIELDS("Repsol Logo");//21Aug2017
