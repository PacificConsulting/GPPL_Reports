report 50001 "Purchase GRN - 1"
{
    ...
    DefaultLayout = RDLC;
    //RDLCLayout = './PurchaseGRN1.rdlc';
    RDLCLayout = 'Src/Report Layout/PurchaseGRN1.rdl';
                        ...
                        IF PWRL09.FINDFIRST THEN BEGIN
                            ...
                            IF PWRH09.GET(PWRL09."No.") THEN
                                IF PWRH09."Vendor Quantity" <> 0 THEN BEGIN
                                    ...
                                    VenQty09 := PWRH09."Vendor Quantity"; //Fahim
                                    VenUOM09 := PWRL09."Unit of Measure Code";
                                    DenFac09 := PWRH09."Density Factor";
                                    ...
                                    //MESSAGE('%1',PWRH09."Vendor Quantity");
                                    //MESSAGE('%1',PWRH09."Density Factor");
                                    //MESSAGE('%1',PWRL09."Quantity");
