report 50036 "Sales Return Order-Export"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/SalesReturnOrderExport.rdl';
    Caption = 'Sales Return Order-Export';
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            column(CurrFactor; "Sales Cr.Memo Header"."Currency Factor")
            {
            }
            dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
            {
                ...
                DataItemTableView = SORTING("Document No.", "Line No.")
                                    WHERE(Type = FILTER(Item | 'Charge (Item)'),
                                          Quantity = FILTER(<> 0));
                column(LineDocNo; "Sales Cr.Memo Line"."Document No.")
                {
                }
                ...
                column(LineBasicRate; "Unit Price" / "Qty. per Unit of Measure")
                {
                }
                column(LineDutyPerUnit; (/*"BED Amount"*/ 0 + /*"SHE Cess Amount"*/0 + 0/*"eCess Amount"*/) / "Quantity (Base)")
                {
                }
                ...
                begin
                    ...
                    BillingPrice := ("Sales Cr.Memo Line"."Unit Price" / "Sales Cr.Memo Line"."Qty. per Unit of Measure")
                                    + (/*"Sales Cr.Memo Line"."Excise Amount"*/0 / ("Sales Cr.Memo Line"."Qty. per Unit of Measure" *
                    ...
                    //For FOCAMOUNT
                    recGLentry.RESET;
                    recGLentry.SETFILTER("G/L Account No.", '75002035');
                    ...
                    //For Freight Charges
                    recGLentry.RESET;
                    recGLentry.SETFILTER("G/L Account No.", '%1|%2', '75001010', '75001025');
                    recGLentry.SETFILTER("Document Type", 'Credit Memo');
                    recGLentry.SETRANGE(recGLentry."Document No.", "Sales Cr.Memo Line"."Document No.");
                    IF recGLentry.FINDFIRST THEN
                    ...
                    CLEAR(EntryTaxDesc);
                    /*  recPostedStrOrdDetails.RESET;
                     recPostedStrOrdDetails.SETRANGE("Invoice No.", "Sales Cr.Memo Header"."No.");
                    ...
                    NetAmt := "Sales Cr.Memo Line".Amount / "Sales Cr.Memo Header"."Currency Factor";

                    Total := (NetAmt + 0/*"Sales Cr.Memo Line"."Tax Amount" */+ Cess + EntryTax + AddlDutyAmount + FOCAMOUNT + TotalDisc +
                             "Trans.Subsidy" + "Cash Discount" + "Invoice Discount" + FreightCharges + RoundOffAmnt);
            ...
            begin
                ...
                UserRec.SETRANGE(UserRec."User Name", "Sales Cr.Memo Header"."User ID");//24Mar2017
