report 50060 "Scrap Sales Invoice - GST"
{
    // Date        Version      Remarks
    // .....................................................................................
    // 11Oct2017   RB-N         New Report Develepment [CAS-18494-F6Z3J7]
    // 31Oct2017   RB-N         Dispalying RespolLogo Or IpolLogo Depending upon ItemCategory
    // 14Nov2017   RB-N         Not to allowing SaveasPDF from Preview Mode
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/ScrapSalesInvoiceGST.rdl';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    Caption = 'Scrap Sales Invoice - GST';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(PlaceofSupply1; ShipState)
            {
            }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(Integer; Integer)
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(BaseUnitOfMeasure; "Unit of Measure Code")
                        {
                        }
                        ...
                        column(BEDant_QtyBase; /*"BED Amount"*/0 / "Quantity (Base)")
                        {
                        }
                        ...
                        column(TCSAmount; 0)//"TDS/TCS Amount")
                        {
                        }
                        ...
                        begin
                            ...
                            TempAmt := "Sales Invoice Line"."Line Amount";
                            //  ELSE
                            TempAmt := 0;//"Sales Invoice Line"."GST Base Amount";
                            ...
                            */
                            ...
                            SHEpercent := 0;// recExcisePostnSetup."SHE Cess %";
                                            //    END;
                            ...
                            */
                            ...
                            DiscAmt06 += 0;// recStrOrderLineDet.Amount;
  ...
  */
                            ...
                            */
                            ...
                            vCheck.InitTextVariable;
                            vCheck.FormatNoText(DescriptionLineAD, ROUND(/*"ADE Amount", 0.01*/0), '');
            ...
            begin
                ...
                //>>01Aug2017
                IF "Sales Invoice Header"."Posting Date" < 00170801D then//010817D THEN
  ...
  */
                ...
                // BarcodeForQuarantineLabel;//RSPLSUM // DJ Comment 06/10/2020
