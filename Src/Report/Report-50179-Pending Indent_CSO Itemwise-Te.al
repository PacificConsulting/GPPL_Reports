report 50179 "Pending Indent/CSO Itemwise-Te"
{
    // 
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/PendingIndentCSOItemwiseTe.rdl';
        ...
        dataitem(Item; Item)
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    IF SH08.FINDFIRST THEN BEGIN
                        SalesPerson := '';
                        IF recSP.GET(SH08."Salesperson Code") THEN
                    ...
                    */
                    ...
                    BEGIN
                        ...
                        EnterCell(RowNo, 18, FORMAT("Quantity Shipped"), FALSE, FALSE, '0.000', 0);
                        EnterCell(RowNo, 19, FORMAT(QuantityToSHipSale), FALSE, FALSE, '0.000', 0);
                        EnterCell(RowNo, 23, FORMAT("Document Type"), FALSE, FALSE, '', 1);
                        EnterCell(RowNo, 24, FORMAT(BinQty / ItemUOM), FALSE, FALSE, '0.000', 0);
                        //EnterCell(RowNo,25,FORMAT(SalesComment),FALSE,FALSE,'',1);
                        EnterCell(RowNo, 25, SalesPerson, FALSE, FALSE, '', 1);//RB-N 31Oct2017

                        //Sales of last three months for customers
                        EnterCell(RowNo, 27, FORMAT(q1), FALSE, FALSE, '0.000', 0);
                        EnterCell(RowNo, 28, FORMAT(q13), FALSE, FALSE, '0.000', 0);//RB-N 31Oct2017

                        EnterCell(RowNo, 29, FORMAT(q2), FALSE, FALSE, '0.000', 0);
                        EnterCell(RowNo, 30, FORMAT(q14), FALSE, FALSE, '0.000', 0);//RB-N 31Oct2017

                        EnterCell(RowNo, 31, FORMAT(q3), FALSE, FALSE, '0.000', 0);
                        EnterCell(RowNo, 32, FORMAT(q15), FALSE, FALSE, '0.000', 0);//RB-N 31Oct2017

                        EnterCell(RowNo, 37, FORMAT(Comm1), FALSE, FALSE, '', 1);//RB-N 31Oct2017
                        EnterCell(RowNo, 38, FORMAT(Comm2), FALSE, FALSE, '', 1);//RB-N 31Oct2017
                        EnterCell(RowNo, 39, FORMAT(Comm3), FALSE, FALSE, '', 1);//RB-N 31Oct2017
                        EnterCell(RowNo, 40, FORMAT(Comm4), FALSE, FALSE, '', 1);//RB-N 31Oct2017
            ...
            dataitem("Transfer Indent Line"; "Transfer Indent Line")
            {
                ...
                begin
                    ...
                    */
                    ...
                    SalesPerson := '';
                    IF recSP.GET("Transfer Indent Line"."Salesperson Code") THEN
                        SalesPerson := recSP.Name;
                    //RSPL-CAS-04663-V8J3G6
                    ...
                    *///Commented 18May2017
                    ...
                    BEGIN
                        ...
                        EnterCell(RowNo, 17, FORMAT(Quantity), FALSE, FALSE, '0.000', 0);//27Mar2017
                        EnterCell(RowNo, 18, FORMAT(QtyShip), FALSE, FALSE, '0.000', 0);
                        EnterCell(RowNo, 19, FORMAT(QuantityToSHipTransfer), FALSE, FALSE, '0.000', 0);
                        EnterCell(RowNo, 23, FORMAT('Indent'), FALSE, FALSE, '', 1);
                        EnterCell(RowNo, 24, FORMAT(BinQty / ItemUOM), FALSE, FALSE, '0.000', 0);
                        //RSPL-CAS-04663-V8J3G6
                        EnterCell(RowNo, 25, FORMAT(SalesPerson), FALSE, FALSE, '', 1);
                        //RSPL-CAS-04663-V8J3G6
                        EnterCell(RowNo, 26, FORMAT(qtyuom), FALSE, FALSE, '0.000', 0); //RSPL-CAS-07044-N8Z9H8
                                                                                        //sales of last three months
                        EnterCell(RowNo, 27, FORMAT(q1), FALSE, FALSE, '0.000', 0);//RB-N Qty 2017
                        EnterCell(RowNo, 28, FORMAT(q13), FALSE, FALSE, '0.000', 0);//RB-N Qty 31Oct2017

                        EnterCell(RowNo, 29, FORMAT(q2), FALSE, FALSE, '0.000', 0);//RB-N Qty 2017
                        EnterCell(RowNo, 30, FORMAT(q14), FALSE, FALSE, '0.000', 0);//RB-N Qty 31Oct2017

                        EnterCell(RowNo, 31, FORMAT(q3), FALSE, FALSE, '0.000', 0);//RB-N Qty 2017
                        EnterCell(RowNo, 32, FORMAT(q15), FALSE, FALSE, '0.000', 0);//RB-N Qty 31Oct2017

                        EnterCell(RowNo, 33, FORMAT(salc1), FALSE, FALSE, '0.000', 0);
                        EnterCell(RowNo, 34, FORMAT(salc2), FALSE, FALSE, '0.000', 0);
                        EnterCell(RowNo, 35, FORMAT(salc3), FALSE, FALSE, '0.000', 0);

                        EnterCell(RowNo, 36, FORMAT(IntransitInv), FALSE, FALSE, '0.000', 0);
                ...
                begin
                    ...
                    IF itemqtytotal <> 0 THEN BEGIN
                        IF ExportToExcel AND (SalesExist OR TransferExists) THEN BEGIN
                            ...
                            EnterCell(RowNo, 17, FORMAT(itemqtytotal), TRUE, FALSE, '0.000', 0);//27Mar2017
                                                                                                //EnterCell(RowNo+3,17,FORMAT(itemqtytotal)+'test tot2',TRUE,FALSE,'0.000',0);
                            EnterCell(RowNo, 18, FORMAT(totqtyship), TRUE, FALSE, '0.000', 0);
                            EnterCell(RowNo, 19, FORMAT(totqtytoship), TRUE, FALSE, '0.000', 0);
                            ...
                            EnterCell(RowNo, 22, FORMAT(BinName), TRUE, FALSE, '', 1);
            ...
            begin
                ...
                IF ExportToExcel AND printheader THEN BEGIN
                    ...
                    EnterCell(2, 37, FORMAT(USERID), TRUE, FALSE, '@', 1);
                    //>>27Mar2017
                    ...
                    EnterCell(7, 12, FORMAT('Approver Name'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 13, FORMAT('Approve Date'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 14, FORMAT('Approve time'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 15, FORMAT('Pack UOM'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 16, FORMAT('Qty per UOM'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 17, FORMAT('Qty. Order as per pack UOM'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 18, FORMAT('Despatched per pack UOM'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 19, FORMAT('Balance  as per pack UOM'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 20, FORMAT('Product Availability'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 21, FORMAT('Excess/Short for Production'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 22, FORMAT('Bin'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 23, FORMAT('Type'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 24, FORMAT('Stock at from Location in Sales UOM'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 25, FORMAT('Salesperson'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 26, FORMAT('Stock at Indented Location in Sales UOM'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 27, FORMAT('Sales for the Month ' + FORMAT(MonthCaption1)), TRUE, TRUE, '@', 1);//RB-N 31Oct2017 2017Year
                    EnterCell(7, 28, FORMAT('Sales for the Month ' + FORMAT(MonthCaption13)), TRUE, TRUE, '@', 1);//RB-N 31Oct2017 2016Year

                    EnterCell(7, 29, FORMAT('Sales for the Month ' + FORMAT(MonthCaption2)), TRUE, TRUE, '@', 1);//RB-N 31Oct2017 2017Year
                    EnterCell(7, 30, FORMAT('Sales for the Month ' + FORMAT(MonthCaption14)), TRUE, TRUE, '@', 1);//RB-N 31Oct2017 2016Year

                    EnterCell(7, 31, FORMAT('Sales for the Month ' + FORMAT(MonthCaption3)), TRUE, TRUE, '@', 1);//RB-N 31Oct2017 2017Year
                    EnterCell(7, 32, FORMAT('Sales for the Month ' + FORMAT(MonthCaption15)), TRUE, TRUE, '@', 1);//RB-N 31Oct2017 2016Year

                    EnterCell(7, 33, FORMAT('Transfer for the Month ' + FORMAT(MonthCaption1)), TRUE, TRUE, '@', 1);
                    EnterCell(7, 34, FORMAT('Transfer for the Month ' + FORMAT(MonthCaption2)), TRUE, TRUE, '@', 1);
                    EnterCell(7, 35, FORMAT('Transfer for the Month ' + FORMAT(MonthCaption3)), TRUE, TRUE, '@', 1);
                    EnterCell(7, 36, FORMAT('Intransit Inventory'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 37, FORMAT('Remarks'), TRUE, TRUE, '@', 1);
                    EnterCell(7, 38, FORMAT('Remarks 2'), TRUE, TRUE, '@', 1); //07Sep2017
                    EnterCell(7, 39, FORMAT('Remarks 3'), TRUE, TRUE, '@', 1); //07Sep2017
                    EnterCell(7, 40, FORMAT('Remarks 4'), TRUE, TRUE, '@', 1); //07Sep2017
    ...
    begin
        ...
        IF ExportToExcel THEN BEGIN
            ...
            TempExcelBuffer1.CreateNewBook('Pending Indent CSO');
            TempExcelBuffer1.WriteSheet('Pending Indent CSO', CompanyName, UserId);
            TempExcelBuffer1.CloseBook();
            TempExcelBuffer1.SetFriendlyFilename(StrSubstNo('Pending Indent CSO', CurrentDateTime, UserId));
