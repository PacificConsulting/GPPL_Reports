// report 50079 "Receipt Voucher GST"
// {
//     // 17July2017 :: RB-N, New Report format for GST Payment Voucher.
//     DefaultLayout = RDLC;
//     RDLCLayout = './ReceiptVoucherGST.rdlc';
...
//                                       Bal. Account Type=FILTER(Customer),
...
//                 IF "G/L Entry"."Source Code" <> 'BANKRCPTV' THEN
//                   ERROR('This report is applicable for Bank Receipt Voucher.');
...
//                 Ven.RESET;
//                 IF Ven.GET("G/L Entry"."Bal. Account No.") THEN
//                 BEGIN

//                   CLEAR(VenGSTRegNo);
//                   VenGSTRegNo := Ven."GST Registration No.";

//                   IF Ven."GST Customer Type" = Ven."GST Customer Type"::Unregistered THEN
//                     VenGSTRegNo := FORMAT(Ven."GST Customer Type");
...
//                   IF DetailGSTEntry."GST Component Code" ='CGST' THEN
//                   BEGIN
...
//                   IF DetailGSTEntry."GST Component Code" ='SGST' THEN
//                   BEGIN
...
//                   IF DetailGSTEntry."GST Component Code" ='IGST' THEN
//                   BEGIN
...
//                 //CLEAR(LineAmt);
//                 LineAmt += ABS(Amount)+vCGST+vSGST+vIGST ;

//                 //>>Amount in Words
//                 RCheck.InitTextVariable;
//                 RCheck.FormatNoText(Amtinwords,(LineAmt+vCGST+vSGST+vIGST),'');
