report 50067 "Sales Order Archives - Auto"
{
    // Date        Version      Remarks
    // .....................................................................................
    // 27Sep2017   RB-N         New Report development for Sales Order Archives Automotive
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/SalesOrderArchivesAuto.rdl';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    Caption = 'Sales Order Archives - Automotives';
    ...
    dataset
    {
        dataitem("Sales Header Archive"; "Sales Header Archive")
        {
            ...
            dataitem("Sales Line Archive"; "Sales Line Archive")
            {
                ...
                column(LineAMt; 0)// "Line Amount" + "Excise Amount" + ProdDisc)
                {
                }
                ...
                column(TotalAmt; "Line Amount" + /*"Excise Amount" + "Charges To Customer" + "Tax Amount"*/0 - "Line Discount Amount")
                {
                }
                ...
                begin
                    ...
                    /*  StructureOrderDet.RESET;
                     ...
                     IF StructureOrderDet.FINDFIRST THEN */
                    AddTaxRate := 0;//StructureOrderDet."Calculation Value";
                    ...
                    */
                    ...
                    IF ("Sales Header Archive"."Ship-to Code" = '') AND ("Sales Header Archive"."Gen. Bus. Posting Group" <> 'FOREIGN') THEN BEGIN
                        ...
                        IF ("Sales Header Archive"."Ship-to Code" <> '') AND ("Sales Header Archive"."Gen. Bus. Posting Group" <> 'FOREIGN') THEN BEGIN
                            ...
                            //MRpMstr.SETRANGE(MRpMstr."Lot No.","Sales Line"."Lot No.");//LotNo
                            ...
                            *///Commented DimensionTable#357---23Mar2017
                            ...
                            IF "Item Category Code" = 'CAT14' THEN BEGIN
