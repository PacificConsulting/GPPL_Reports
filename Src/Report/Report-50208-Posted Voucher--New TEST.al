report 50208 "Posted Voucher--New TEST"
{
    // 
    ...
    // 10Jul2017   RB-N         AccName Value increased to 80 Length (Oldvalue to 50 Length)
    // 03Nov2017   RB-N         Journal Voucher with multiple no Post & Print.
    // 18Dec2017   RB-N         PageLoop Reduceto 12
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/PostedVoucherNewTEST.rdl';
    ...
    dataset
    {
        dataitem("G/L Entry"; "G/L Entry")
        {
            ...
            dataitem("Dimension Set Entry"; "Dimension Set Entry")
            {
                ...
                begin
                    ...
                    */
                    ...
                    //MESSAGE('%1,%2,%3',"Dimension Set Entry".COUNT,TIME,'Dimension Set Entry');
            ...
            dataitem(LineNarration; "Posted Narration")
            {
                ...
                begin
                    ...
                    //MESSAGE('%1,%2,%3',LineNarration.COUNT,TIME,'LineNarration');
                end;
            }
            dataitem(Integer; Integer)
            {
                ...
                begin
                    ...
                    //MESSAGE('%1,%2,%3',Integer.COUNT,TIME,'Integer');
                end;
            ...
            dataitem(PostedNarration1; "Posted Narration")
            {
                ...
                trigger OnAfterGetRecord()
                begin
                    //MESSAGE('%1,%2,%3',PostedNarration1.COUNT,TIME,'PostedNarration1');
                end;
            ...
            dataitem("Purch. Comment Line"; "Purch. Comment Line")
            {
                ...
                trigger OnAfterGetRecord()
                begin
                    //MESSAGE('%1,%2,%3',"Purch. Comment Line".COUNT,TIME,'Purch. Comment Line');
                end;
            }
            dataitem("Sales Comment Line"; "Sales Comment Line")
            {
                ...
                trigger OnAfterGetRecord()
                begin
                    //MESSAGE('%1,%2,%3',"Sales Comment Line".COUNT,TIME,'Sales Comment Line');
                end;
            }
            ...
            begin
                ...
                *///commented 15May2017
                ...
                IF "System-Created Entry" THEN
                    IF "G/L Account No." = '12913047' THEN
                ...
                IF "Document Type" = "Document Type"::"Credit Memo" THEN
                    IF SCH31.GET("Document No.") THEN BEGIN
                        SAE31.RESET;
                        SAE31.SETCURRENTKEY("Document Type", "Document No.");
                        SAE31.SETRANGE("Document Type", SAE31."Document Type"::"Sales CrMemo");
                        SAE31.SETRANGE("Document No.", SCH31."Pre-Assigned No.");
                        SAE31.SETRANGE(Approved, TRUE);
                        IF SAE31.FINDLAST THEN BEGIN
                            UserName := SAE31."User Name";
                            IF SAE31."Level2 Approvar ID" <> '' THEN
                                App31 := SAE31."Level2 Approvar Name"
                            ELSE
                                App31 := SAE31."Approver Name";
                        END;
                    END;
                //<<31Oct2018
                //>>NAV2009 05Apr2017
                ...
                PostedPInv.RESET;
                IF PostedPInv.GET("G/L Entry"."Document No.") THEN BEGIN
                    Loc.RESET;
                    IF Loc.GET(PostedPInv."Location Code") THEN
                        RState.RESET;
                    IF RState.GET(Loc."State Code") THEN
                        RecLoc := 'Receiving Location :- ' + Loc."State Code" + '-' + RState."State Code (GST Reg. No.)";

                    Ven.RESET;
                    IF Ven.GET(PostedPInv."Buy-from Vendor No.") THEN
                        RState.RESET;
                    IF RState.GET(Ven."State Code") THEN
                        VenLoc := 'Vendor Location:- ' + Ven."State Code" + '-' + RState."State Code (GST Reg. No.)";

                    //>>
                    IF PostedPInv."Order Address Code" <> '' THEN BEGIN
                        OrdAdd.RESET;
                        IF OrdAdd.GET(PostedPInv."Buy-from Vendor No.", PostedPInv."Order Address Code") THEN
                            RState.RESET;
                        IF RState.GET(OrdAdd.State) THEN
                            VenLoc := 'Vendor Location:- ' + OrdAdd.State + '-' + RState."State Code (GST Reg. No.)";
                    END;
                    //<<

                    VendorInvoNo := FORMAT(UPPERCASE(PostedPInv."Vendor Invoice No.")) + ',    Date :- ' + FORMAT(PostedPInv."Document Date") + ',    ' + RecLoc + ',   ' + VenLoc;
                END ELSE
                    VendorInvoNo := '';
                //<<2
                ...
                IF "G/L Entry"."Global Dimension 2 Code" <> '' THEN
                    IF RespCtr.GET("G/L Entry"."Global Dimension 2 Code") THEN;
                ...
                IF ("G/L Entry"."G/L Account No." = '12915080') OR ("G/L Entry"."G/L Account No." = '51010030') OR ("G/L Entry"."G/L Account No." = '51035703') OR
                   ...
                   ("G/L Entry"."G/L Account No." = '75003040') OR ("G/L Entry"."G/L Account No." = '75003050') THEN BEGIN
                    ...
                    BEGIN //17May2017
                        ...
                        //>>14July2017
                        /*  PosStr14.RESET;
                         PosStr14.SETCURRENTKEY(Type, "Document Type", "Invoice No.");
                ...
                //MESSAGE('%1,%2,%3',"G/L Entry".COUNT,TIME,'G/L Entry');
        ...
        dataitem("G/L Entry 1"; "G/L Entry")
        {
            ...
            dataitem("G/L Entry 2"; "G/L Entry")
            {
                ...
                trigger OnAfterGetRecord()
                begin
                    //MESSAGE('%1,%2,%3',"G/L Entry 2".COUNT,TIME,'G/L Entry 2');
                end;
            }
            ...
            begin
                ...
                //<<NAV2009
                MESSAGE('%1,%2,%3',"G/L Entry 1".COUNT,TIME,'G/L Entry 1');
                */
