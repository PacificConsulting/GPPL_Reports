report 50130 "Vendor Balance Confirmation Ne"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/VendorBalanceConfirmationNe.rdl';
            ...
            dataitem(OpenVendorLedgEntry; "Vendor Ledger Entry")
            {
                ...
                begin
                    IF AgingBy = AgingBy::"Posting Date" THEN BEGIN
                        ...
                        // IF "Remaining Amt. (LCY)" = 0 THEN //RK-Comment-18-09-2019
                        //  CurrReport.SKIP; //RK-Comment-18-09-2019
                    END;
                    InsertTemp(OpenVendorLedgEntry);
                    //CurrReport.SKIP;//RK-Comment
                end;
            ...
            dataitem(CurrencyLoop; Integer)
            {
                ...
                dataitem(TempVendortLedgEntryLoop; Integer)
                {
                    ...
                    begin
                        ...
                        //IF VendorLedgEntryEndingDate."Remaining Amount" = 0 THEN //RK-Comment-18-09-2019
                        //CurrReport.SKIP;//RK-Comment-18-09-2019
