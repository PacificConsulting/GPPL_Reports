report 50087 "Purchase Order Detailed"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/GPPL/Report Layout/PurchaseOrderDetailed.rdl';
  ...
  */
                    ...
                    /* IF "Purchase Line"."Excise Amount" <> 0 THEN
                    BEGIN
                    recExcise.RESET;
