report 50200 "Trading Invoice GST"
{
    // 
    ...
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/TradingInvoiceGST.rdl';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(LocGSTNo; Location."GST Registration No.")
            {
            }
            column(LocationDetails; Location.Address + ' ' + Location."Address 2" + ' ' + Location.City + '-' + Location."Post Code" + ' ' + LocState + ' ' + 'Phone: ' + Location."Phone No." + 'Email: ' + Location."E-Mail")
            {
            }
 ...
 */
    ...
    */
            ...
            begin
                ...
                //IF BLocation ='' THEN
                //ERROR('Please Specify B/L Location'); //Fahim (Commmented on 05-10-21 as per Apara email)
                ...
                //>>06Apr2017
                IF Location.GET(BLocation) THEN BEGIN
