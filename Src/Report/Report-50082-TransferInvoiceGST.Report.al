report 50082 "Transfer Invoice -  GST"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/TransferInvoiceGST.rdl';
    Caption = 'Transfer Invoice -  GST';
    ...
    dataset
    {
        dataitem("Transfer Shipment Header"; "Transfer Shipment Header")
        {
            ...
            column(TransComment; recInvComment.Comment)
            {
            }
