report 50129 "Vendor - Ledgeracconut1"
{
    ...
    RDLCLayout = 'Src/Report Layout/VendorLedgeracconut1.rdl';
        ...
        dataitem(Vendor; Vendor)
        {
            ...
            dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
            {
                ...
                begin
                    ...
                    RecGSTLedEntry.SETCURRENTKEY("Document No.", "Posting Date");
                    RecGSTLedEntry.SETRANGE("Document No.", "Document No.");
                    RecGSTLedEntry.SETRANGE("Posting Date", "Posting Date");
                    IF RecGSTLedEntry.FINDSET THEN
                        REPEAT
                            vServiceTaxAmt += RecGSTLedEntry."GST Amount";
                        UNTIL RecGSTLedEntry.NEXT = 0;
                    //RSPLSUM 06Dec19<<
                    ...
                    DebitTotal += "Vendor Ledger Entry"."Debit Amount (LCY)";//RSPLSUM 02Mar2020
                    CreditTotal += "Vendor Ledger Entry"."Credit Amount (LCY)";//RSPLSUM 02Mar2020
            ...
            begin
                ...
                //<<
                CLEAR(DebitTotal);//RSPLSUM 02Mar2020
                CLEAR(CreditTotal);//RSPLSUM 02Mar2020
            end;
    ...
    begin
        ...
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, TRUE, '@', ExcelBuf."Cell Type"::Text);
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, TRUE, '@', ExcelBuf."Cell Type"::Text);
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, TRUE, '@', ExcelBuf."Cell Type"::Text);//RSPLSUM 02Mar2020
    ...
    begin
        ...
        IF vServiceTaxAmt <> 0 THEN BEGIN
            ...
            ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);
            ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);
            //RSPLSUM 06Aug2020--ExcelBuf.AddColumn('Service Tax  Amount',FALSE,'',FALSE,FALSE,FALSE,'',ExcelBuf."Cell Type"::Text);
            ExcelBuf.AddColumn('Service Tax Amount/GST', FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);//RSPLSUM 06Aug2020
