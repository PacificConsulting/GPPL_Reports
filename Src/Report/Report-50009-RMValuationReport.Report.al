// report 50009 "RM Valuation Report"
// {
...
//     DefaultLayout = RDLC;
//     RDLCLayout = './RMValuationReport.rdlc';
...
//                                 WHERE("Item Category Code" = FILTER(CAT01 | CAT05 | CAT06 | CAT04 | CAT07 | CAT08 | CAT09 | CAT10 | CAT16 | CAT15),
...
//                 CLEAR(SkipNegAdj);//RSPLSUM03May21
//                 IF "Entry Type" = "Entry Type"::"Negative Adjmt." THEN
//                     IF "Applies-to Entry" <> 0 THEN BEGIN
//                         CLEAR(ILE0505);
//                         IF ILE0505.GET("Applies-to Entry") THEN
//                             //RSPLSUM03May21>>
//                             IF ILE0505."Posting Date" <= PostingDate THEN BEGIN
//                                 RemQty := 0;
//                                 SkipNegAdj := TRUE;
//                             END ELSE BEGIN
//                                 RemQty := Quantity;
...
//                         //RSPLSUM03May21<<
//                         /*RSPLSUM03May21>>
//                         IF "Posting Date" < ILE0505."Posting Date" THEN
//                         BEGIN
//                           NegativeCorrection := TRUE;
//                           RemQty := Quantity;
//                         END;
...
//                 IF SkipNegAdj THEN//RSPLSUM03May21
//                     CurrReport.SKIP;//RSPLSUM03May21
...
//                     accessvalue := Purchinvln."Assessable Value";
//                     ADEAmt := Purchinvln."ADE Amount";
...
//                     IF ValueEntryreccc.FINDFIRST THEN BEGIN
...
//         END
//         //IF  "Item Ledger Entry"."Item Category Code" = 'CAT05' THEN
//         //BEGIN
//         /*
//         ELSE
//         BEGIN
//         ExcelBuf.AddColumn((TotalCharges + costcat5),FALSE,'',FALSE,FALSE,FALSE,'');
//         ExcelBuf.AddColumn((TotalCharges + costcat5)*RemQty,FALSE,'',FALSE,FALSE,FALSE,'');
//         END;
//         */
//         ELSE BEGIN
...
//         //ExcelBuf.AddColumn("Item Ledger Entry"."Assessable Value",FALSE,'',FALSE,FALSE,FALSE,'');
//         //ExcelBuf.AddColumn((accessvalue * RemQty)+ADEAmt,FALSE,'',FALSE,FALSE,FALSE,'');
//         //>>05May2019
