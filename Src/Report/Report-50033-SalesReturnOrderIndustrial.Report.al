report 50033 "Sales Return Order-Industrial"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Src/Report Layout/SalesReturnOrderIndustrial.rdl';
    Caption = 'Sales Return Order-Industrial';
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
            {
                ...
                column(LineECessAmt; 0)//ss"eCess Amount")
                {
                }
                ...
                begin
                    ...
                    recPostedStrOrdDetails.SETFILTER(recPostedStrOrdDetails."Tax/Charge Code",'ADDL TAX');
                    recPostedStrOrdDetails.SETRANGE(recPostedStrOrdDetails."Calculation Type",recPostedStrOrdDetails."Calculation Type"::Percentage);
                    ...
                    */
                    ...
                    //For FOCAMOUNT
                    recGLentry.RESET;
                    recGLentry.SETFILTER("G/L Account No.", '%1|%2', '51010030', '75002035');
                    ...
                    SalesCreditMemoLine.SETFILTER(SalesCreditMemoLine."No.", RoundOffAcc);
    ...
    */
                    ...
                    NetAmt := "Sales Cr.Memo Line".Amount + 0/*"Sales Cr.Memo Line"."BED Amount" */+ 0/* "Sales Cr.Memo Line"."eCess Amount" */+
                   0 /*"Sales Cr.Memo Line"."SHE Cess Amount" */+ "Sales Cr.Memo Line"."Line Discount Amount" + "Sales Cr.Memo Line"."Inv. Discount Amount";
                ...
                begin
                    ...
                    //>>1
                    CurrReport.CREATETOTALS(QtyPackUOM);
                    //<<1
            ...
            begin
                ...
                UserRec.RESET;
                UserRec.SETRANGE("User Name", "Sales Cr.Memo Header"."User ID");//21Mar2017
